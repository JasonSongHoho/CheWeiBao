...
public class ApplyedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_applyed);
        init();
    }
    ...
    public void init() {
        ...
        listView = (ListView) this.findViewById(R.id.listView_applyed);
        ...
        //条目点击事件
        listView.setOnItemClickListener(new ApplyedActivity.ItemClickListener());


        Button LoadButton = (Button) findViewById(R.id.load_but_applyed);
    ...
    protected void dialog(final String placeId) {
        new AlertDialog.Builder(ApplyedActivity.this).setTitle("系统提示")//设置对话框标题

                .setMessage("确认取消申请吗？")//设置显示的内容
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {//添加确定按钮
                    @Override
                    public void onClick(DialogInterface dialog, int which) {//确定按钮的响应事件
                        // TODO Auto-generated method stub
                        placeService.cancelApply(placeId, userId);
                    }
